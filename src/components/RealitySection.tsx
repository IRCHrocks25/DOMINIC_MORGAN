...
export default function RealitySection() {
  ...
  return (
    <section ref={ref} className="py-16 sm:py-20 lg:py-24 bg-[#F6F7F9] relative overflow-x-hidden">
      {/* Decorative Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-[#2C2C2C]/80 mx-auto leading-relaxed text-sm sm:text-base lg:text-lg px-2" style={{ width: '100%', maxWidth: '1200px' }}>
            Ambitious professionals are burning out, drifting off course, and questioning the meaning of success. <span className="font-semibold text-[#0E2043]">Rebel Coaching</span> exists to meet
            this quiet crisis with clarity, authenticity, and personal power. These stats paint a sobering but essential picture and show exactly why
            coaching built on purpose and truth matters more than ever.
          </p>
        </motion.div>

        {/* Statistics - Single container: grid on desktop, scroll on mobile */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 sm:mb-16 justify-items-center max-w-[900px] mx-auto">
          {statistics.map((stat, index) => (
            <motion.div
              ...
              className="group relative w-full max-w-[280px] h-[280px]"
            >
              ...
              <div className="relative bg-white rounded-2xl p-6 shadow-sm group-hover:shadow-xl transition-all duration-300 border border-[#99A9C9]/10 flex flex-col w-full h-full">
                {/* Percentage */}
                <motion.div
                  initial={{ scale: 0 }}
